...
Next phase: damage simulator (`apps/api/app/services/damage_calc.py`) + Next.js frontend in `apps/web/`. See [`PROJECT.md` §9](./PROJECT.md#9-phased-build-plan) for the full plan.
